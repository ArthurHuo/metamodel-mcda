 ...
 * <ul>
 *   <li>{@link mcda.demo1.impl.CriteriaImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CriteriaImpl extends MinimalEObjectImpl.Container implements Criteria {
	...
	protected EClass eStaticClass() {
		return mcdaPackage.Literals.CRITERIA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, mcdaPackage.CRITERIA__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case mcdaPackage.CRITERIA__NAME:
				return getName();
		}
