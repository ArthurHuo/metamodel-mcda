...
public class McdaBracketSet {
	...
	private java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements mcda.demo1.resource.mcda.IMcdaBracketPair {
	 ...
	 */
	private class ClosingListener implements mcda.demo1.resource.mcda.ui.IMcdaBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				mcda.demo1.resource.mcda.IMcdaBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public McdaBracketSet(mcda.demo1.resource.mcda.ui.McdaEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaBracketPair>();
	 ...
	 */
	public mcda.demo1.resource.mcda.IMcdaBracketPair getBracketPair(String opening, String closing) {
		for (mcda.demo1.resource.mcda.IMcdaBracketPair bracketPair : bracketPairs) {
	...
	public mcda.demo1.resource.mcda.IMcdaBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(mcda.demo1.resource.mcda.IMcdaBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + mcda.demo1.resource.mcda.ui.McdaPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public mcda.demo1.resource.mcda.IMcdaBracketPair remove(String opening, String closing) {
		for (mcda.demo1.resource.mcda.IMcdaBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, mcda.demo1.resource.mcda.ui.McdaPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, mcda.demo1.resource.mcda.ui.McdaPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
