 ...
 * @since 3.2
 */
public class McdaBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput fInput;
	 ...
	 */
	public McdaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public McdaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public McdaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput);
		...
		fInput= (mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput) input;
		...
		mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput getInput() {
		return fInput;
	}
