 ...
 */
public class McdaCodeFoldingManager {
	
	private class FoldingUpdateListener implements mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(mcda.demo1.resource.mcda.ui.McdaEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof mcda.demo1.resource.mcda.ui.McdaEditor) {
				mcda.demo1.resource.mcda.ui.McdaEditor editor = (mcda.demo1.resource.mcda.ui.McdaEditor) workbenchPart;
	...
	protected mcda.demo1.resource.mcda.ui.McdaEditor editor;
	 ...
	 */
	public McdaCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,mcda.demo1.resource.mcda.ui.McdaEditor textEditor) {
	...
	private void addCloseListener(final mcda.demo1.resource.mcda.ui.McdaEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		mcda.demo1.resource.mcda.IMcdaTextResource textResource = (mcda.demo1.resource.mcda.IMcdaTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
