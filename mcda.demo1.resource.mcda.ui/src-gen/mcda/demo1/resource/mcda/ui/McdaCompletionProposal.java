 ...
 */
public class McdaCompletionProposal implements java.lang.Comparable<McdaCompletionProposal> {
	 ...
	 */
	private mcda.demo1.resource.mcda.mopp.McdaExpectedTerminal expectedTerminal;
	...
	public McdaCompletionProposal(mcda.demo1.resource.mcda.mopp.McdaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public McdaCompletionProposal(mcda.demo1.resource.mcda.mopp.McdaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public McdaCompletionProposal(mcda.demo1.resource.mcda.mopp.McdaExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public mcda.demo1.resource.mcda.mopp.McdaExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof McdaCompletionProposal) {
			McdaCompletionProposal other = (McdaCompletionProposal) object;
	...
	public int compareTo(McdaCompletionProposal object) {
		if (object instanceof McdaCompletionProposal) {
			McdaCompletionProposal other = (McdaCompletionProposal) object;
