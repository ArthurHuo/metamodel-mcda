 ...
 * olInput</code>.
 */
public class McdaDocBrowserInformationControlInput {
	
	private final McdaDocBrowserInformationControlInput fPrevious;
	private McdaDocBrowserInformationControlInput fNext;
	 ...
	 */
	public McdaDocBrowserInformationControlInput(McdaDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public McdaDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public McdaDocBrowserInformationControlInput getNext() {
		return fNext;
	}
