...
/**
 * A text editor for 'mcda' models.
 * <p>
 * This editor has id <code>mcda.demo1.resource.mcda.ui.McdaEditor</code>
 * The editor's context menu has id
 * <code>mcda.demo1.resource.mcda.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>mcda.demo1.resource.mcda.EditorRuler</code>.
 * </p>
 */
public class McdaEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, mcda.demo1.resource.mcda.IMcdaResourceProvider, mcda.demo1.resource.mcda.ui.IMcdaBracketHandlerProvider, mcda.demo1.resource.mcda.ui.IMcdaAnnotationModelProvider {
	
	private mcda.demo1.resource.mcda.ui.McdaHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private mcda.demo1.resource.mcda.ui.McdaCodeFoldingManager codeFoldingManager;
	private mcda.demo1.resource.mcda.ui.McdaBackgroundParsingStrategy bgParsingStrategy = new mcda.demo1.resource.mcda.ui.McdaBackgroundParsingStrategy();
	private java.util.Collection<mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener>();
	private mcda.demo1.resource.mcda.ui.McdaColorManager colorManager = new mcda.demo1.resource.mcda.ui.McdaColorManager();
	private mcda.demo1.resource.mcda.ui.McdaOutlinePage outlinePage;
	...
	private mcda.demo1.resource.mcda.ui.McdaPropertySheetPage propertySheetPage;
	...
	private mcda.demo1.resource.mcda.ui.IMcdaBracketHandler bracketHandler;
	...
	public McdaEditor() {
		super();
		setSourceViewerConfiguration(new mcda.demo1.resource.mcda.ui.McdaSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), McdaEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								mcda.demo1.resource.mcda.IMcdaTextResource currentResource = getResource();
				...
				mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("mcda.demo1.resource.mcda.EditorContext");
		setRulerContextMenuId("mcda.demo1.resource.mcda.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new mcda.demo1.resource.mcda.ui.McdaHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new mcda.demo1.resource.mcda.ui.McdaCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		mcda.demo1.resource.mcda.mopp.McdaNature.activate(inputFile.getProject());
		...
		mcda.demo1.resource.mcda.IMcdaTextResource loadedResource = (mcda.demo1.resource.mcda.IMcdaTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				mcda.demo1.resource.mcda.IMcdaTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof mcda.demo1.resource.mcda.IMcdaTextResource) {
					setResource((mcda.demo1.resource.mcda.IMcdaTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					mcda.demo1.resource.mcda.ui.McdaUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the McdaEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(mcda.demo1.resource.mcda.IMcdaTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new mcda.demo1.resource.mcda.ui.McdaOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new mcda.demo1.resource.mcda.ui.McdaPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			mcda.demo1.resource.mcda.IMcdaTextResource textResource = (mcda.demo1.resource.mcda.IMcdaTextResource) element.eResource();
			mcda.demo1.resource.mcda.IMcdaLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			mcda.demo1.resource.mcda.IMcdaTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				mcda.demo1.resource.mcda.IMcdaTextToken token = lexer.getNextToken();
			...
			mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!McdaEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public mcda.demo1.resource.mcda.ui.IMcdaBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(mcda.demo1.resource.mcda.ui.IMcdaBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof mcda.demo1.resource.mcda.IMcdaTextResource)) {
					return false;
				}
				mcda.demo1.resource.mcda.IMcdaTextResource textResource = (mcda.demo1.resource.mcda.IMcdaTextResource) resource;
				mcda.demo1.resource.mcda.IMcdaLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
