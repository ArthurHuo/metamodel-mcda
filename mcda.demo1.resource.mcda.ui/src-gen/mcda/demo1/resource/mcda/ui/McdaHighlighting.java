 ...
 */
public class McdaHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static mcda.demo1.resource.mcda.ui.McdaPositionHelper positionHelper = new mcda.demo1.resource.mcda.ui.McdaPositionHelper();
	...
	private mcda.demo1.resource.mcda.ui.McdaTokenScanner scanner;
	...
	private mcda.demo1.resource.mcda.ui.McdaOccurrence occurrence;
	private mcda.demo1.resource.mcda.ui.McdaBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, mcda.demo1.resource.mcda.IMcdaBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public McdaHighlighting(mcda.demo1.resource.mcda.IMcdaTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, mcda.demo1.resource.mcda.ui.McdaColorManager colorManager, mcda.demo1.resource.mcda.ui.McdaEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = mcda.demo1.resource.mcda.ui.McdaUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new mcda.demo1.resource.mcda.ui.McdaTokenScanner(textResource, colorManager);
		occurrence = new mcda.demo1.resource.mcda.ui.McdaOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new mcda.demo1.resource.mcda.ui.McdaBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(mcda.demo1.resource.mcda.ui.McdaPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, mcda.demo1.resource.mcda.ui.McdaPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(mcda.demo1.resource.mcda.ui.McdaEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, mcda.demo1.resource.mcda.ui.McdaPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, mcda.demo1.resource.mcda.ui.McdaPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(mcda.demo1.resource.mcda.ui.McdaPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new mcda.demo1.resource.mcda.ui.McdaEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
