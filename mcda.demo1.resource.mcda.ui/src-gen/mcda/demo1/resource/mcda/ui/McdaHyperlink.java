 ...
 */
public class McdaHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public McdaHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				mcda.demo1.resource.mcda.mopp.McdaPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
