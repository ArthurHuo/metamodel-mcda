 ...
 * hovers, is a proxy.
 */
public class McdaHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public McdaHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (mcda.demo1.resource.mcda.IMcdaTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new mcda.demo1.resource.mcda.ui.McdaHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
