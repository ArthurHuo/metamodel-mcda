...
public class McdaMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(mcda.demo1.resource.mcda.IMcdaOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof mcda.demo1.resource.mcda.mopp.McdaResource) {
					mcda.demo1.resource.mcda.mopp.McdaResource customResource = (mcda.demo1.resource.mcda.mopp.McdaResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<mcda.demo1.resource.mcda.IMcdaQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final mcda.demo1.resource.mcda.IMcdaQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<mcda.demo1.resource.mcda.IMcdaQuickFix> getQuickFixes(mcda.demo1.resource.mcda.IMcdaTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					mcda.demo1.resource.mcda.IMcdaQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
