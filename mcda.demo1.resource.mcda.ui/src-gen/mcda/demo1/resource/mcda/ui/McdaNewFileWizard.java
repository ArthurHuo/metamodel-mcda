...
public class McdaNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private mcda.demo1.resource.mcda.ui.McdaNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public McdaNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new mcda.demo1.resource.mcda.ui.McdaNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			mcda.demo1.resource.mcda.ui.McdaUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getSyntaxName();
	}
