 ...
 */
public class McdaNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public McdaNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new mcda file");
