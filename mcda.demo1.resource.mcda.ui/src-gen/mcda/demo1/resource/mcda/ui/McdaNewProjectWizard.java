 ...
 */
public class McdaNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("mcda.demo1.resource.mcda.ui");
							...
							String natureID = mcda.demo1.resource.mcda.mopp.McdaNature.NATURE_ID;
							...
							for (String builderID : mcda.demo1.resource.mcda.mopp.McdaNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								mcda.demo1.resource.mcda.mopp.McdaMetaInformation info = new mcda.demo1.resource.mcda.mopp.McdaMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = mcda.demo1.resource.mcda.ui.McdaUIPlugin.getDefault().getBundle();
