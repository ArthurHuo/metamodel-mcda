 ...
 * a specified depth.
 */
public class McdaOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public McdaOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = mcda.demo1.resource.mcda.util.McdaStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof mcda.demo1.resource.mcda.ui.McdaEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			mcda.demo1.resource.mcda.mopp.McdaPlugin.logError("Exception while refreshing outline view", e);
		}
	}
