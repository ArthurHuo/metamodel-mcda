 ...
 */
public class McdaSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private mcda.demo1.resource.mcda.ui.McdaQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public McdaSourceViewerConfiguration(mcda.demo1.resource.mcda.IMcdaResourceProvider resourceProvider, mcda.demo1.resource.mcda.ui.IMcdaAnnotationModelProvider annotationModelProvider, mcda.demo1.resource.mcda.ui.IMcdaBracketHandlerProvider bracketHandlerProvider, mcda.demo1.resource.mcda.ui.McdaColorManager colorManager) {
		super(mcda.demo1.resource.mcda.ui.McdaUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new mcda.demo1.resource.mcda.ui.McdaCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new mcda.demo1.resource.mcda.ui.McdaTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new mcda.demo1.resource.mcda.ui.McdaTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new mcda.demo1.resource.mcda.ui.McdaHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new mcda.demo1.resource.mcda.ui.McdaQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new mcda.demo1.resource.mcda.ui.McdaIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
