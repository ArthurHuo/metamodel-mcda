 ...
 */
public class McdaSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public McdaSyntaxColoringPreferencePage() {
		super();
		
		mcda.demo1.resource.mcda.mopp.McdaMetaInformation metaInformation = new mcda.demo1.resource.mcda.mopp.McdaMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mcda.demo1.resource.mcda.ui.McdaSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		mcda.demo1.resource.mcda.ui.McdaPixelConverter pixelConverter = new mcda.demo1.resource.mcda.ui.McdaPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof mcda.demo1.resource.mcda.ui.McdaEditor) {
			mcda.demo1.resource.mcda.ui.McdaEditor emfTextEditor = (mcda.demo1.resource.mcda.ui.McdaEditor) editor;
