 ...
 */
public class McdaTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private mcda.demo1.resource.mcda.IMcdaHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput infoInput = (mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					mcda.demo1.resource.mcda.ui.McdaHyperlink hyperlink = new mcda.demo1.resource.mcda.ui.McdaHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl iControl = new mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput) {
							mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput input = (mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl.isAvailable(parent)) {
				mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl iControl = new mcda.demo1.resource.mcda.ui.McdaBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public McdaTextHover(mcda.demo1.resource.mcda.IMcdaResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new mcda.demo1.resource.mcda.ui.McdaUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.insertPageProlog(buffer, 0, mcda.demo1.resource.mcda.ui.McdaTextHover.getStyleSheet());
			mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.addPageEpilog(buffer);
			return new mcda.demo1.resource.mcda.ui.McdaDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = mcda.demo1.resource.mcda.ui.McdaHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(mcda.demo1.resource.mcda.ui.McdaUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return mcda.demo1.resource.mcda.util.McdaStreamUtil.getContent(styleSheetURL.openStream());
