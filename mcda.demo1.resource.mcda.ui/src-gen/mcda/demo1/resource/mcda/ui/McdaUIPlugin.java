 ...
 */
public class McdaUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "mcda.demo1.resource.mcda.ui";
	public static final String EDITOR_ID = "mcda.demo1.resource.mcda.ui.McdaEditor";
	...
	private static McdaUIPlugin plugin;
	...
	public static McdaUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, McdaUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, McdaUIPlugin.PLUGIN_ID, message);
		}
		final McdaUIPlugin pluginInstance = McdaUIPlugin.getDefault();
