 ...
 * 
 */
package mcda.demo1.resource.mcda.ui.debug;

@SuppressWarnings("restriction")
public class McdaAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getSyntaxName())) {
					return new mcda.demo1.resource.mcda.ui.debug.McdaLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof mcda.demo1.resource.mcda.debug.McdaDebugVariable) {
			final mcda.demo1.resource.mcda.debug.McdaDebugVariable variable = (mcda.demo1.resource.mcda.debug.McdaDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof mcda.demo1.resource.mcda.debug.McdaDebugVariable) {
			final mcda.demo1.resource.mcda.debug.McdaDebugVariable variable = (mcda.demo1.resource.mcda.debug.McdaDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							mcda.demo1.resource.mcda.debug.McdaDebugValue castedValue = (mcda.demo1.resource.mcda.debug.McdaDebugValue) value;
