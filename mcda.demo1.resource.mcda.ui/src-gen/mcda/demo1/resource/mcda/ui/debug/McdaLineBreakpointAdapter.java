...
public class McdaLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(mcda.demo1.resource.mcda.mopp.McdaPlugin.DEBUG_MODEL_ID);
			...
			mcda.demo1.resource.mcda.debug.McdaLineBreakpoint lineBreakpoint = new mcda.demo1.resource.mcda.debug.McdaLineBreakpoint(resource, lineNumber + 1);
