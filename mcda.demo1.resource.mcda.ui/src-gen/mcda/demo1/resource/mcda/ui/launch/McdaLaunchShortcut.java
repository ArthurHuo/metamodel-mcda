 ...
 */
public class McdaLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(mcda.demo1.resource.mcda.launch.McdaLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			mcda.demo1.resource.mcda.mopp.McdaPlugin.logError("Exception while launching selection", e);
		}
	}
