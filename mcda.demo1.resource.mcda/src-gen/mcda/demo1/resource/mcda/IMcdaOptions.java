 ...
 */
public interface IMcdaOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getResourcePostProcessorProviderOptionKey();
