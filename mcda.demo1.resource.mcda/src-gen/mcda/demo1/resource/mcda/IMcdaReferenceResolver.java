 ...
 * resolver
 */
public interface IMcdaReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends mcda.demo1.resource.mcda.IMcdaConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, mcda.demo1.resource.mcda.IMcdaReferenceResolveResult<ReferenceType> result);
