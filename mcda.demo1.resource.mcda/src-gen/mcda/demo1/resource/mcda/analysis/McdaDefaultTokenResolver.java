 ...
 */
public class McdaDefaultTokenResolver implements mcda.demo1.resource.mcda.IMcdaTokenResolver {
	 ...
	 */
	public McdaDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public McdaDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, mcda.demo1.resource.mcda.IMcdaTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : mcda.demo1.resource.mcda.grammar.McdaGrammarInformationProvider.INSTANCE.getKeywords()) {
