...
public class McdaDebugValue extends mcda.demo1.resource.mcda.debug.McdaDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public McdaDebugValue(mcda.demo1.resource.mcda.debug.McdaDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
