...
public class McdaLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "mcda.demo1.resource.mcda.debug.lineBreakpoint.marker";
	
	public McdaLineBreakpoint() {
		super();
	}
	
	public McdaLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(mcda.demo1.resource.mcda.debug.McdaDebugTarget target) {
		try {
	...
	public void remove(mcda.demo1.resource.mcda.debug.McdaDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
