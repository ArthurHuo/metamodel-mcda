...
public class McdaStackFrame extends mcda.demo1.resource.mcda.debug.McdaDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private mcda.demo1.resource.mcda.debug.McdaDebugTarget target;
	private String name;
	private int id;
	...
	public McdaStackFrame(mcda.demo1.resource.mcda.debug.McdaDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = mcda.demo1.resource.mcda.util.McdaStringUtil.decode(data, ',');
	...
	private mcda.demo1.resource.mcda.debug.McdaDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		mcda.demo1.resource.mcda.debug.McdaStackFrame other = (mcda.demo1.resource.mcda.debug.McdaStackFrame) obj;
		if (name == null) {
