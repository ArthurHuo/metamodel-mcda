...
public class McdaBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "mcda.demo1.resource.mcda.builder";
	
	private mcda.demo1.resource.mcda.IMcdaBuilder defaultBuilder = new mcda.demo1.resource.mcda.mopp.McdaBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		mcda.demo1.resource.mcda.IMcdaBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			mcda.demo1.resource.mcda.mopp.McdaResource customResource = (mcda.demo1.resource.mcda.mopp.McdaResource) resourceSet.getResource(uri, true);
			new mcda.demo1.resource.mcda.mopp.McdaMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public mcda.demo1.resource.mcda.IMcdaBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new mcda.demo1.resource.mcda.mopp.McdaMarkerHelper().getMarkerID(mcda.demo1.resource.mcda.McdaEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		mcda.demo1.resource.mcda.mopp.McdaTaskItemBuilder taskItemBuilder = new mcda.demo1.resource.mcda.mopp.McdaTaskItemBuilder();
		new mcda.demo1.resource.mcda.mopp.McdaMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().getSyntaxName())) {
