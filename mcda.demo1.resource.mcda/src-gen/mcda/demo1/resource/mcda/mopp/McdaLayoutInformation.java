...
/**
 * McdaLayoutInformation objects are used to store layout information that is
 ...
 * McdaLayoutInformations are aggregated in LayoutInformationAdapters. One
 * McdaLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class McdaLayoutInformation {
	 ...
	 */
	private final mcda.demo1.resource.mcda.grammar.McdaSyntaxElement syntaxElement;
	...
	public McdaLayoutInformation(mcda.demo1.resource.mcda.grammar.McdaSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public mcda.demo1.resource.mcda.grammar.McdaSyntaxElement getSyntaxElement() {
