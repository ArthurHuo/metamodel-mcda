...
/**
 * A McdaLayoutInformationAdapter is used to store layout information that is
 ...
 * McdaLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class McdaLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<mcda.demo1.resource.mcda.mopp.McdaLayoutInformation> layoutInformations = new java.util.ArrayList<mcda.demo1.resource.mcda.mopp.McdaLayoutInformation>();
	...
	public java.util.List<mcda.demo1.resource.mcda.mopp.McdaLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(mcda.demo1.resource.mcda.mopp.McdaLayoutInformation layoutInformation) {
