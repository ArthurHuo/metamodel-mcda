 ...
 * contains <code>mcda.demo1.resource.mcda.IMcdaTextDiagnostic</code>s it uses the
 * more precise information of this extended diagnostic type.
 */
public class McdaMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = mcda.demo1.resource.mcda.mopp.McdaPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<mcda.demo1.resource.mcda.IMcdaCommand<Object>> commands = new java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(mcda.demo1.resource.mcda.IMcdaCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<mcda.demo1.resource.mcda.IMcdaCommand<Object>> commandsToProcess = new java.util.ArrayList<mcda.demo1.resource.mcda.IMcdaCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (mcda.demo1.resource.mcda.IMcdaCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, mcda.demo1.resource.mcda.IMcdaTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final mcda.demo1.resource.mcda.IMcdaTextDiagnostic diagnostic) {
		final mcda.demo1.resource.mcda.IMcdaProblem problem = diagnostic.getProblem();
		mcda.demo1.resource.mcda.McdaEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new mcda.demo1.resource.mcda.IMcdaCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == mcda.demo1.resource.mcda.McdaEProblemSeverity.ERROR) {
					...
					mcda.demo1.resource.mcda.IMcdaTextDiagnostic textDiagnostic = (mcda.demo1.resource.mcda.IMcdaTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof mcda.demo1.resource.mcda.mopp.McdaResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((mcda.demo1.resource.mcda.mopp.McdaResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<mcda.demo1.resource.mcda.IMcdaQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, mcda.demo1.resource.mcda.util.McdaStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (mcda.demo1.resource.mcda.McdaEProblemType nextType : mcda.demo1.resource.mcda.McdaEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, mcda.demo1.resource.mcda.McdaEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(mcda.demo1.resource.mcda.McdaEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(mcda.demo1.resource.mcda.McdaEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new mcda.demo1.resource.mcda.util.McdaRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new mcda.demo1.resource.mcda.IMcdaCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					mcda.demo1.resource.mcda.mopp.McdaPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
