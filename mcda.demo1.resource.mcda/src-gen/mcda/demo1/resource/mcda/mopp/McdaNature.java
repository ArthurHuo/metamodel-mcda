...
public class McdaNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "mcda.demo1.resource.mcda.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {mcda.demo1.resource.mcda.mopp.McdaBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(mcda.demo1.resource.mcda.mopp.McdaBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
