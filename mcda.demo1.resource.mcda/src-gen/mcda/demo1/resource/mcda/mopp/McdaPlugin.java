 ...
 */
public class McdaPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "mcda.demo1.resource.mcda";
	/**
	...
	private static McdaPlugin plugin;
	...
	public static McdaPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, McdaPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, McdaPlugin.PLUGIN_ID, message);
		}
		final McdaPlugin pluginInstance = McdaPlugin.getDefault();
