...
public class McdaResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public McdaResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new mcda.demo1.resource.mcda.util.McdaRuntimeUtil().isEclipsePlatformAvailable()) {
			new mcda.demo1.resource.mcda.util.McdaEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new mcda.demo1.resource.mcda.mopp.McdaResourceFactory());
		}
	}
