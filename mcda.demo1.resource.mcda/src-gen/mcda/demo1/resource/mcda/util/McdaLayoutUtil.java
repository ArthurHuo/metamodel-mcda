...
public class McdaLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<mcda.demo1.resource.mcda.mopp.McdaLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			mcda.demo1.resource.mcda.mopp.McdaLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				mcda.demo1.resource.mcda.mopp.McdaLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(mcda.demo1.resource.mcda.mopp.McdaLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		mcda.demo1.resource.mcda.grammar.McdaSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), mcda.demo1.resource.mcda.grammar.McdaGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public mcda.demo1.resource.mcda.mopp.McdaLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		mcda.demo1.resource.mcda.grammar.McdaSyntaxElement syntaxElement = mcda.demo1.resource.mcda.grammar.McdaGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof mcda.demo1.resource.mcda.grammar.McdaPlaceholder) {
			mcda.demo1.resource.mcda.grammar.McdaPlaceholder placeholder = (mcda.demo1.resource.mcda.grammar.McdaPlaceholder) syntaxElement;
			mcda.demo1.resource.mcda.IMcdaTokenResolver tokenResolver = new mcda.demo1.resource.mcda.mopp.McdaTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			mcda.demo1.resource.mcda.IMcdaTokenResolveResult result = new mcda.demo1.resource.mcda.mopp.McdaTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new mcda.demo1.resource.mcda.mopp.McdaLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public mcda.demo1.resource.mcda.mopp.McdaLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
