	...
	public static <K> void putAndMergeKeys(java.util.Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof java.util.List<?>) {
				...
				java.util.List<Object> currentValueAsObjectList = mcda.demo1.resource.mcda.util.McdaListUtil.copySafelyToObjectList(currentValueAsList);
