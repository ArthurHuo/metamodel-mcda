...
public class McdaResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new mcda.demo1.resource.mcda.util.McdaInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new mcda.demo1.resource.mcda.util.McdaInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static mcda.demo1.resource.mcda.mopp.McdaResource getResource(java.io.File file) {
	...
	public static mcda.demo1.resource.mcda.mopp.McdaResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new mcda.demo1.resource.mcda.mopp.McdaMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (mcda.demo1.resource.mcda.mopp.McdaResource) resource;
	}
	 ...
	 */
	public static mcda.demo1.Task getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static mcda.demo1.Task getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (mcda.demo1.Task) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static mcda.demo1.Task getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		mcda.demo1.resource.mcda.IMcdaTextResource resource = (mcda.demo1.resource.mcda.IMcdaTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (mcda.demo1.resource.mcda.IMcdaTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		mcda.demo1.resource.mcda.IMcdaTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
