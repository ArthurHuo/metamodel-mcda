...
public class McdaStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, mcda.demo1.resource.mcda.IMcdaFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, mcda.demo1.resource.mcda.IMcdaFunction1<String, T> toStringFunction) {
