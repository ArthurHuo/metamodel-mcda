 ...
 * to 4 bytes).
 */
public class McdaUnicodeConverter extends mcda.demo1.resource.mcda.mopp.McdaInputStreamProcessor {
	 ...
	 */
	public McdaUnicodeConverter(java.io.InputStream inputStream) {
